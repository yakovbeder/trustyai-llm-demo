...
spec:
  ...
  - additionalPrinterColumns:
    ...
    schema:
      openAPIV3Schema:
        description: EvalHub is the Schema for the evalhubs API
        properties:
          apiVersion:
            description: |-
          ...
          metadata:
            type: object
          spec:
            description: EvalHubSpec defines the desired state of EvalHub
            properties:
              database:
                description: |-
                ...
                properties:
                  ...
                  maxOpenConns:
                    ...
                    type: integer
                  secret:
                    description: Name of the K8s Secret containing a pre-composed
                      db-url key
                    type: string
                required:
                - secret
                type: object
              env:
                description: Environment variables for the eval-hub container
                items:
          ...
          status:
            ...
            properties:
              ...
              lastUpdateTime:
                ...
                type: string
              phase:
                description: Current phase of the EvalHub (Pending, Ready, Error)
                enum:
                - Pending
                - Ready
                - Error
                type: string
              ready:
                description: Ready indicates whether the EvalHub is ready to serve
                  requests
                type: string
              readyReplicas:
              ...
              replicas:
                ...
                type: integer
              url:
                description: URL where the EvalHub service is accessible
                type: string
            type: object
        type: object
    served: true
          ...
          spec:
            ...
            properties:
              ...
              customDetectorsConfig:
                ...
                type: string
              disableOrchestrator:
                description: ' Boolean flag to disable the orchestrator container,
                  if running the built-in detectors in standalone mode'
                type: boolean
              ...
              logLevel:
                ...
                type: string
              orchestratorConfig:
                description: Name of configmap containing generator, detector, and
                  chunker arguments
                type: string
              otelExporter:
                ...
                properties:
                  ...
                  otlpProtocol:
                    default: grpc
                    description: Sets the protocol for both traces and metrics
                    type: string
                  otlpTracesEndpoint:
          ...
          spec:
            ...
            properties:
              ...
              batchSize:
                ...
                type: string
              chatTemplate:
                description: ChatTemplate defines whether to apply the default or
                  specified chat template to prompts. This is required for chat-completions
                  models.
                properties:
                  enabled:
                    type: boolean
              ...
              pod:
                ...
                properties:
                  affinity:
                    ...
                    type: object
                  container:
                    description: Extra container data for the lm-eval container
                    properties:
                      env:
                        description: Define Env information for the main container
                        items:
                      ...
                      securityContext:
                        ...
                        type: object
                      volumeMounts:
                        description: Define the volume mount information
                        items:
                  ...
                  sideCars:
                    ...
                    type: array
                  volumes:
                    description: Specify the volumes information for the lm-eval and
                      sidecar containers
                    items:
              ...
              taskList:
                ...
                properties:
                  ...
                  taskNames:
                    ...
                    type: array
                  taskRecipes:
                    description: Task Recipes specifically for Unitxt
                    items:
                      description: |-
          ...
          status:
            ...
            properties:
              ...
              podName:
                ...
                type: string
              progressBars:
                description: Information about the current job progress
                items:
                  description: ProgressBar stores information about progress of various
                    steps within an evaluation task.
                  properties:
                    count:
                      description: Fractional progress through the evaluation step,
                        presented as "$completed_items/$total_items"
                      type: string
                    elapsedTime:
                      description: The elapsed time that this step has been running
                      type: string
                    message:
                      description: The title of the step being performed
                      type: string
                    percent:
                      description: The percent completion of this evaluation step
                      type: string
                    remainingTimeEstimate:
                      description: The estimated time remaining for this evaluation
                        step
                      type: string
                  required:
                  - count
      ...
      openAPIV3Schema:
        ...
        properties:
          ...
          metadata:
            type: object
          spec:
            description: NemoGuardrailsSpec defines the desired state of NemoGuardrails
            properties:
              caBundleConfig:
                description: CABundleConfig defines the CA bundle configuration for
                  custom certificates
                properties:
                  configMapKeys:
                    description: |-
              ...
              env:
                ...
                type: array
              nemoConfigs:
                description: NemoConfig should be the names of the configmaps containing
                  NeMO server configuration files. All files in NemoConfigs will be
                  mounted to /app/config/$Name
                items:
                  description: NemoConfig holds information related to a single configuration
                    of the NeMo Guardrails server
                  properties:
                    configMaps:
                      description: ConfigMaps is a list of configmaps that comprise
                        the configuration. All files from these configmaps will be
                        mounted within /app/config/$Name
                      items:
                        type: string
                      type: array
                    default:
                      description: The Default flag determines whether config is treated
                        as the default config for the nemo-server. If no config is
                        set to default, the first entry in NemoConfigs will be used
                        as the default
                      type: boolean
                    name:
                      description: Name sets the id of this particular config within
                        ...
                        /app/config/$Name. Since it $Name will be used a directory,
                        it must only contain alphanumeric characters, dashes, and
                        underscores.
                      pattern: ^[a-zA-Z0-9_-]+$
                      type: string
                  type: object
            ...
            type: object
          status:
            description: NemoGuardrailStatus defines the observed state of NemoGuardrails
            properties:
              ca:
                description: CA describes the status of the CA configmaps
                properties:
                  odhTrustedCAError:
                    type: string
                  odhTrustedCAFound:
                    type: boolean
                  openshiftServingCAError:
                    type: string
                  openshiftServingCAFound:
                    type: boolean
                  userCAError:
                    type: string
                  userCAFound:
                ...
                type: object
              conditions:
                description: Conditions describes the state of the NemoGuardrails
                  resource.
                items:
                  properties:
                    lastTransitionTime:
...
metadata:
  labels:
    app.kubernetes.io/component: evalhub-jobs
    app.kubernetes.io/created-by: trustyai-service-operator
    app.kubernetes.io/instance: evalhub-jobs-proxy-role
    app.kubernetes.io/managed-by: kustomize
...
metadata:
  labels:
    ...
    app.kubernetes.io/part-of: trustyai
  name: trustyai-service-operator-evalhub-resource-manager
rules:
- apiGroups:
  - ""
  resources:
...
metadata:
  labels:
    ...
    app.kubernetes.io/name: trustyai-service-operator
    app.kubernetes.io/part-of: trustyai
  name: trustyai-service-operator-nemoguardrail-editor-role
rules:
- apiGroups:
  - trustyai.opendatahub.io
  resources:
...
metadata:
  labels:
    ...
    app.kubernetes.io/name: trustyai-service-operator
    app.kubernetes.io/part-of: trustyai
  name: trustyai-service-operator-nemoguardrail-viewer-role
rules:
- apiGroups:
  - trustyai.opendatahub.io
  resources:
...
metadata:
  labels:
    ...
    app.kubernetes.io/part-of: trustyai
  name: trustyai-service-operator-default-lmeval-user-rolebinding
roleRef:
  apiGroup: rbac.authorization.k8s.io
  kind: ClusterRole
  name: trustyai-service-operator-lmeval-user-role
...
metadata:
  labels:
    ...
    app.kubernetes.io/name: trustyai-service-operator
    app.kubernetes.io/part-of: trustyai
  name: trustyai-service-operator-evalhub-resource-manager-binding
roleRef:
  apiGroup: rbac.authorization.k8s.io
  kind: ClusterRole
  name: trustyai-service-operator-evalhub-resource-manager
...
data:
  ...
  nemo-guardrails-image: quay.io/trustyai/nemo-guardrails-dev:latest
...
metadata:
  labels:
    ...
    app.kubernetes.io/part-of: trustyai
    control-plane: controller-manager
  name: trustyai-service-operator-metrics-service
  namespace: redhat-ods-applications
spec:
  ports:
  - name: metrics
  ...
  template:
    ...
    spec:
      ...
      - args:
        - --leader-elect
        - --enable-services
        - TAS,LMES,GORCH,NEMO_GUARDRAILS,EVALHUB
        command:
        - /manager
...
metadata:
  labels:
    ...
    app.kubernetes.io/part-of: trustyai
    control-plane: controller-manager
  name: trustyai-service-operator-service-monitor
  namespace: redhat-ods-applications
spec:
  endpoints:
  - path: /metrics
